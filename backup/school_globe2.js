...
/**
 * This file has been modified to include many of the changes
 * presented in Making of the World Wonders 3D Globe:
 *
...
DAT.Globe = function(container, opts) {
    ...
    var initializeSphere = function () {
        ...
        var sphereMaterial = new THREE.ShaderMaterial({
            ...
            fragmentShader: fragmentShader(40, 40, 40)
        });
    ...
    var initializeContinents = function () {
        ...
        var continentsMaterial = new THREE.ShaderMaterial({
            vertexShader: vertexShader(),
            fragmentShader: fragmentShader(122, 184, 0)
        });
